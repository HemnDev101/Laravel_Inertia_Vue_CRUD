        ...
        <div class="py-12">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex  ">
                    ...
                    <form class="max-w-sm mx-auto" @submit.prevent="updateTopic">
                        <div class="mb-5 py-6">
...
<center>
    <div  class="my-5">
        <img :src="image" alt="" class="w-1/2 h-1/2  ">
    </div>
</center>
                        ...
                        <button type="submit" class="bg-blue-500 hover:bg-blue-600 rounded px-4 py2 my-6 text-white" >Update</button>
